...
public class LegacySMCreateForgeRockUserTest {
	...
	@Mock
	LegacySMCreateForgeRockUser.LegacyFRConfig config;
	...
	private LegacySMCreateForgeRockUser node;
	...
	public void setup() throws Exception {
		...
		node = new LegacySMCreateForgeRockUser(config, realm, secrets, new HttpClientHandler());
	}
	...
	@Test
	public void testProcessFailedAgentInitFailed() throws NodeProcessException {
		given(config.is4xAgent()).willReturn(true);
