...
public class LegacyORASetPasswordTest {
	...
	public void shouldReturnFalseOutcomeWhenWrongHost() throws Exception {
		LegacyORASetPassword passwordNode = node("http://somehost.example.com", OPENIDM_ADMIN_USER,
	...
	public void shouldReturnFalseOutcomeWhenWrongCredentials() throws Exception {
		LegacyORASetPassword passwordNode = node(LOCAL_IDM, OPENIDM_ADMIN_USER, OPENIDM_ADMIN_SECRET);
		assertEquals(passwordNode.process(mockContext).outcome, "false");
	}
	...
	private LegacyORASetPassword node(String idmEndpoint, String idmUser, String idmPasswordId)
			throws NodeProcessException, HttpApplicationException {
		return new LegacyORASetPassword(new LegacyORASetPassword.Config() {
