...
public class AddAttributesToObjectAttributesNodeTest {
	...
	@Test
	public void objectAttributesNullOnSharedStateTransientStateEmptyTestTrue() throws NodeProcessException {
		// Given
	...
	@Test
	public void objectAttributesNullOnSharedStateAddOnEmptyTransientStateTestTrue() throws NodeProcessException {
		// Given
		sharedState = JsonValue.json(JsonValue.object(JsonValue.field(USERNAME, USER)));
	...
	@Test
	public void objectAttributesOnSharedStateAddOnEmptyTransientStateTestTrue() throws NodeProcessException {
		// Given
		sharedState = JsonValue.json(JsonValue.object(JsonValue.field(USERNAME, USER),
	...
	@Test
	public void AttributesMapEmptyTestTrue() throws NodeProcessException {
		// Given
		sharedState = JsonValue.json(JsonValue.object(JsonValue.field(USERNAME, USER),
				JsonValue.field(OBJECT_ATTRIBUTES, JsonValue.object(JsonValue.field("key", "value")))));
		transientState = JsonValue.json(JsonValue.object(JsonValue.field(PASSWORD, USER_PASSWORD)));
	...
	@Test
	public void objectAttributesOnSharedStateAddOnTransientStateTestTrue() throws NodeProcessException {
		// Given
		sharedState = JsonValue.json(JsonValue.object(JsonValue.field(USERNAME, USER),
				JsonValue.field(OBJECT_ATTRIBUTES, JsonValue.object(JsonValue.field("key", "value")))));
		transientState = JsonValue.json(JsonValue.object(JsonValue.field(PASSWORD, USER_PASSWORD),
