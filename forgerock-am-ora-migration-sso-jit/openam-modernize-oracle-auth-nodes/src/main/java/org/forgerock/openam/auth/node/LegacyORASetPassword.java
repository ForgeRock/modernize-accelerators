 ...
 *
 */
@Node.Metadata(configClass = LegacyORASetPassword.Config.class, outcomeProvider = AbstractDecisionNode.OutcomeProvider.class)
public class LegacyORASetPassword extends AbstractDecisionNode {

	private Logger LOGGER = LoggerFactory.getLogger(LegacyORASetPassword.class);
	...
	@Inject
	public LegacyORASetPassword(@Assisted LegacyORASetPassword.Config config, @Assisted Realm realm, Secrets secrets)
