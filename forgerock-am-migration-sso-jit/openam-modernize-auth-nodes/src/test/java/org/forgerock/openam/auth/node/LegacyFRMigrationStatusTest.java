...
public class LegacyFRMigrationStatusTest {
	...
	public void shouldReturnFalseOutcomeWhenWrongHostForGetStatus() throws Exception {
		LegacyFRMigrationStatus getMigrationStatusNode = node(LOCAL_IDM, OPENIDM_ADMIN_USER, OPENIDM_ADMIN_SECRET);
	...
	public void shouldReturnTrueOutcomeWhenWhenEndpointAndCredentialsAreCorrectForGetStatus() throws Exception {
		LegacyFRMigrationStatus getMigrationStatusNode = node(LOCAL_IDM, OPENIDM_ADMIN_USER, OPENIDM_ADMIN_SECRET);
		assertEquals(getMigrationStatusNode.process(mockContext).outcome, "true");
	}

	private LegacyFRMigrationStatus node(String idmEndpoint, String idmUser, String idmPasswordId)
			throws NodeProcessException, HttpApplicationException {
		return new LegacyFRMigrationStatus(new LegacyFRMigrationStatus.Config() {
